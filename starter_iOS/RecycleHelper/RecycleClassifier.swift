...
class RecycleClassifier: ObservableObject {
    ...
    private func performClassification(image: UIImage) -> RecycleResult {
        ...
        // It represents an image as a grid of pixels (bitmap) plus info like width, height, color space, bits per component, etc.
...
//        }
        ...
        // It’s a high-level request you use when you want the system to tell you what’s in an image using Apple’s built-in image classification models
